...
%% article.
\begin{abstract}
\input{PUT INDIVIDUAL SECTIONS HERE/abstract}
\end{abstract}
...
\input{PUT INDIVIDUAL SECTIONS HERE/introduction}

\section{Background}
\input{PUT INDIVIDUAL SECTIONS HERE/background}

\section{Approach}
\input{PUT INDIVIDUAL SECTIONS HERE/approach}

\section{Outline of Project Plan}
\input{PUT INDIVIDUAL SECTIONS HERE/outline}

\section{Evaluation}
\input{PUT INDIVIDUAL SECTIONS HERE/evaluation}

\section{Conclusions and Future Work}
\input{PUT INDIVIDUAL SECTIONS HERE/conclusion}
...
\input{report/PUT INDIVIDUAL SECTIONS HERE/division}
